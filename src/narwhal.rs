...
use crate::narwhal::schema::ColumnType;
use crate::narwhal::storage::Storage;
...
mod tests {
    ...
    #[test]
    fn run() {
        let mut narwhal = build_crean_database();
        narwhal
        ...
        narwhal
            ...
            .unwrap();
        let result = narwhal.execute("test_db", "SELECT * FROM users").unwrap();
        assert_eq!(
            result,
    ...
    fn build_crean_database() -> Narwhal {
